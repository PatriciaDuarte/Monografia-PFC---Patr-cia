...
Na Tabela~\ref{tab:correlatos} foram sumarizados os trabalhos estudados, especificando os autores, cultura/local, tipo de imageamento, método principal e precisão. Mais detalhes de cada trabalho são detalhados nas seções a seguir.
...
\hline
Maillard e Gomes (2016)&Nogueiras, laranjeiras, mangueiras e macieiras, Não especificado.&Imagens de satélite coletadas via Google Earth&Método baseado em template& +90\% e -75\%\\
\hline
...
Koch, Heyder e Weinacker (2006)&Carvalho Inglês, Carvalho Vermelho e Maple Norueguês,Alemanha &Imagens por tecnologia laser a partir de sensores LIDAR instalados em aeronaves&	Filtragem máxima local e Watershed&	87.3\%\\
\hline
Strimbu e Strimbu (2015)&Contagem de três espécies de Pinus, Não especificado&Imagens obtidas com técnicas laser com sensor LIDAR em aviões&	Segmentação baseada em grafo&	87\% - 100\%\\
\hline
Kestur et al. (2018)&Contagem de Plantações de manga, banana e coqueiros da Índia, Não especificado&Imagens de alta resolução espacial de veículos aéreos não tripulados (VANTs)&	Watershed&	Não especificado\\
\hline
...
\hline
PUTTEMANS; BEECK; GOEDEMé, 2018&Contagem de coqueiros, Não especificado&	Imagens aéreas de alta resolução&Cascata e Aprendizado profundo& 97.4\% e  94.56\%\\
\hline
Reis, Oliveira e Carvalho (2007)&	Contagem de Eucalyptus ssp, Não especificado&Imagens de alta resolução&	Classificador ISODATA&93.58\%\\
\hline
...
\hline
Bazi, Al-Sharari e Melgani (2009)&Contagem de Oliveiras, Não especificado&Imagens de alta resolução coletadas pelo satélite IKONOS-2&Método de detecção de regiões(blobs)&96\%\\
\hline
Bazi et al. (2014)&	Contagem palmeiras, Não especificado&Imagens captadas por VANT&	Scale Invariant Feature Transform (SIFT) e Extreme Learning Machine&91.11\%\\
\hline
Rizeei H. Z. M. Shafri e Kalantar (2018)&Contagem de dendezeiros, Não especificado&Imagens de satélite Worldview-3 e  LiDAR& 	Segmentação baseada em bordas&	98.80\% \\
\hline
 \end{longtable}
