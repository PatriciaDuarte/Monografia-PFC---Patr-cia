...
\titulo{Estudo de técnicas de processamento de imagens para contagem de árvores \sergio{em imagens de satélite}}
...
\textoresumo[brazil]{
   ...
   \sergio{A contagem de árvores é importante para várias aplicações envolvendo manejo, análise, e geração de inventários agrícolas e florestais. Atualmente não existe métodos automáticos universais para a contagem de árvores, contudo há tecnologias de imageamento aéreo como satélites de alta resolução de imagem e drones de custo acessível que podem ser usados como captar imagens. Por lado tem-se o avanço da computação e o surgimento de variadas técnicas de visão computacional que podem ser aplicadas para a contagem de árvores. Este projeto visa o desenvolvimento e análise de métodos de análise para detecção e contagem de árvores com base em segmentação por inundação e em detecção de picos. Espera-se produzir contribuições científicas e desenvolver métodos de alta precisão para a detecção e contagem de árvores. FALAR DEPOIS SOBRE A METODOLOGIA E OS RESULTADOS INICIAIS!} 
...
\sergio{SERÁ ATUALIZADO APÓS FINALIZAR O RESUMO.}
